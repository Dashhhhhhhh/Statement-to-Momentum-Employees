...
export const deliveries: Delivery[] = [
  { id: 'd001', trackingNumber: 'MOM-224801', recipient: 'Amazon — CMH1 Fulfillment',    address: '6050 Gateway Blvd',       city: 'Groveport',  state: 'OH', status: 'delivered',  driver: 'Unassigned', route: 'RT-07', scheduledDate: '2026-03-27', deliveredAt: '2026-03-27T08:42:00', weight: '318 lbs', notes: '' },
  { id: 'd002', trackingNumber: 'MOM-224802', recipient: 'Amazon — CMH2 Sort Center',    address: '2600 Tradeport Blvd',     city: 'Columbus',   state: 'OH', status: 'delivered',  driver: 'Unassigned', route: 'RT-07', scheduledDate: '2026-03-27', deliveredAt: '2026-03-27T10:05:00', weight: '540 lbs', notes: 'Loading dock B' },
  { id: 'd003', trackingNumber: 'MOM-224803', recipient: 'Amazon — CMH3 Fulfillment',    address: '1000 Rickenbacker Pkwy W', city: 'Columbus',  state: 'OH', status: 'in-transit', driver: 'Unassigned', route: 'RT-07', scheduledDate: '2026-03-27', deliveredAt: null,                   weight: '412 lbs', notes: '' },
  { id: 'd004', trackingNumber: 'MOM-224804', recipient: 'Amazon — CMH4 Delivery Stn',   address: '5500 Crosswind Rd',       city: 'Columbus',   state: 'OH', status: 'in-transit', driver: 'Unassigned', route: 'RT-07', scheduledDate: '2026-03-27', deliveredAt: null,                   weight: '227 lbs', notes: 'Signature required' },
  ...
  { id: 'd007', trackingNumber: 'MOM-224807', recipient: 'Amazon — LCK1 Air Hub',        address: '2260 Cargo Rd',           city: 'Columbus',   state: 'OH', status: 'exception',  driver: 'Unassigned', route: 'RT-07', scheduledDate: '2026-03-26', deliveredAt: null,                   weight: '175 lbs', notes: 'Access gate code rejected — contact site ops' },
  { id: 'd008', trackingNumber: 'MOM-224808', recipient: 'Walmart DC — Obetz',           address: '3800 Fisher Rd',          city: 'Columbus',   state: 'OH', status: 'delivered',  driver: 'Unassigned', route: 'RT-04', scheduledDate: '2026-03-26', deliveredAt: '2026-03-26T13:18:00', weight: '892 lbs', notes: '' },
  ...
  { id: 'd010', trackingNumber: 'MOM-224810', recipient: 'FedEx Ground — Columbus Hub',  address: '1600 Georgesville Rd',    city: 'Columbus',   state: 'OH', status: 'delivered',  driver: 'Unassigned', route: 'RT-04', scheduledDate: '2026-03-25', deliveredAt: '2026-03-25T11:50:00', weight: '244 lbs', notes: '' },
]

export const routes: RouteRecord[] = [
  { id: 'RT-04', name: 'Columbus Southside — Groveport & Obetz',   driver: 'Unassigned', region: 'Central Ohio', stops: 8,  completed: 8, status: 'complete',   vehicleId: 'VH-2218', startTime: '06:00', estimatedEnd: '13:30' },
  { id: 'RT-07', name: 'Columbus East — Rickenbacker Corridor',     driver: 'Unassigned', region: 'Central Ohio', stops: 10, completed: 6, status: 'active',     vehicleId: 'VH-1104', startTime: '07:30', estimatedEnd: '15:45' },
  ...
  { id: 'RT-13', name: 'Columbus North — Crosswind & Polaris',      driver: 'Unassigned', region: 'Central Ohio', stops: 9,  completed: 4, status: 'active',     vehicleId: 'VH-3302', startTime: '06:45', estimatedEnd: '15:00' },
